...
// import { projectImages } from "@/data/projectImages"; // Adjust import path to your projectImages array
                ...
                <div className="relative">
                    ...
                    <div className="flex gap-4 overflow-x-auto pb-4 scroll-smooth snap-x snap-mandatory md:hidden">
                        {projectImages.map((image, index) => (
                            <div key={index} className="min-w-70 shrink-0 snap-start">
                    ...
                    <div className="hidden grid-cols-2 gap-5 md:grid lg:grid-cols-4">
                        {projectImages.slice(0,12).map((image, index) => (
