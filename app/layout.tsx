...
import SchemaScript from "@/seo/schemas/BusinessSchema";
...
export const metadata: Metadata = {
  ...
  description:
    "AutoDrop Car Repair Mobile Mechanic Dubai is professional car repair service in Dubai. We provide mobile mechanic services for all types of vehicles, including cars, trucks, and motorcycles. Our team of experienced mechanics is available 24/7 to provide emergency roadside assistance and car repair services at your location.",
};
