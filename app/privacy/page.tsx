...
export const metadata: Metadata = {
  title: "Privacy Policy | AutoFix Mobile Mechanic Dubai",
  description: "Read our privacy policy to understand how AutoFix Mobile Mechanic Dubai collects, uses, and protects your personal information. Your privacy matters to us.",
  keywords: "privacy policy, data protection, personal information, GDPR, UAE privacy law, AutoFix privacy, mobile mechanic Dubai",
  alternates: {
    canonical: "https://www.autofixmechanicdubai.com/privacy",
  },
  openGraph: {
    title: "Privacy Policy | AutoFix Mobile Mechanic Dubai",
    description: "Learn how AutoFix Mobile Mechanic Dubai protects your personal information and privacy.",
    url: "https://www.autofixmechanicdubai.com/privacy",
        ...
        <div className="mx-auto max-w-4xl">
          ...
          <div id="usage" className="mb-12 scroll-mt-24">
            ...
            <div className="mt-4 grid gap-4 sm:grid-cols-2">
              ...
              <div className="flex items-start gap-3 rounded-lg border border-zinc-800 bg-zinc-900/30 p-4">
                <RiSecurityLine className="h-5 w-5 flex-shrink-0 text-primary" />
                <div>
          ...
          <div className="mb-12 scroll-mt-24">
            <div className="flex items-center gap-3 border-b border-zinc-800 pb-4">
              <RiSecurityLine className="h-6 w-6 text-primary" />
